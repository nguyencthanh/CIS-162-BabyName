...
public class BabyNamesDatabaseGUI extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (database.countAllNames() == 0)
            ...
            else if(buttonPressed == mostPopularButton){
                displayMostPopular();
            }
    ...
    private void displayMostPopular (){
        ...
        try{
            ...
            resultsArea.setText ("Most Popular Names for year " + number);
    ...
    private void displayCounts () {
        ...
        resultsArea.append("\nTotal Boys: " + fmt.format(database.countAllGirls()));
        resultsArea.append("\nTotal Girls: " + fmt.format(database.countAllBoys()));
    }
